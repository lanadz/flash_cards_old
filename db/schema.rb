...
ActiveRecord::Schema.define(version: 20171216142315) do
  ...
  create_table "learning_sessions", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "categpry_id"
    t.integer "correct_answers"
    t.integer "wrong_answers"
    t.integer "cards_amount"
    t.datetime "started_at"
    t.datetime "finished_at"
    t.index ["categpry_id"], name: "index_learning_sessions_on_categpry_id"
    t.index ["started_at"], name: "index_learning_sessions_on_started_at"
